...
import { getAllCourse } from "@/api/admin.api";
...
export default function Orders() {
    ...
    const fetchData = async () => {
        try {
            const data = await getAllCourse(currentPage)
    ...
    return (
        <div className="flex flex-col gap-5 p-5 bg-[#071739] w-[80%] overflow-y-auto scrollbar-hide h-[calc(100vh-70px)]">
            <div className="bg-[#1b2b4d] flex justify-between shadow p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-white">Tổng quan khóa học</h3>
                    ...
                    <table className="table-auto w-full border-collapse border border-gray-200">
                        <thead className="bg-blue-500 text-white">
                            <tr>
                                ...
                                <th className="border border-[#33333] px-4 py-2">Rating</th>
                                <th className="border border-[#33333] px-4 py-2">Order</th>
                        ...
                        <tbody className="bg-white">
                            {courses.map((course, index) => (
                                <tr key={index} className={`${index % 2 === 0 ? 'bg-[#1b2b4d]' : 'bg-[#17223e]'} text-white`}>
                                    ...
                                    <td className="border border-[#33333] px-4 py-2 text-center">{course.rating || 'N/A'}</td>
                                    <td className="border border-[#33333] px-4 py-2 text-center">{course.sold}</td>
